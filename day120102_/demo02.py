...
adv_data = pd.read_excel(r"/Users/hayleygao/PycharmProjects/Data_Analysis/day120102/test_data02.xlsx")
# 清洗不需要的数据
# new_adv_data = adv_data.ix[:, 1:]
new_adv_data = adv_data.iloc[:, 1:]  # 这里 没有ix属性，pandas升级，使用DataFrame的loc方法或者iloc方法进行替换。.loc[],中括号里面是先行后列，以逗号分割；
